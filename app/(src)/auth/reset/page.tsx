...
import ResetForm from "@/lib/components/modules/auth/ResetForm";
          ...
          <div className="box h-full place-center">
            ...
            <div className="lg:w-[550px] mx-auto bg-white lg:px-16 p-6">
              ...
              <div className="mt-6 lg:mt-6">
                <p className="text-xl fw-600">Password Reset</p>
                <p className="mt-3 fs-500">
                  Please input the OTP forwarded to your mail and new password
                </p>
              </div>
